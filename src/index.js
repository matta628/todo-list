...
function makeExampleProjects() {
  ...
  const todo1 = TodoList('name 1', 'desc 1', 'due date 1', 'priority 1', 'status 1', project1);
  const todo2 = TodoList('name 2', 'desc 2', 'due date 2', 'priority 2', 'status 2', project1);
  const todo3 = TodoList('name 3', 'desc 3', 'due date 3', 'priority 3', 'status 3', project1);
  const todo4 = TodoList('name 4', 'desc 4', 'due date 4', 'priority 4', 'status 4', project1);
  const todo5 = TodoList('name 5', 'desc 5', 'due date 5', 'priority 5', 'status 5', project1);
